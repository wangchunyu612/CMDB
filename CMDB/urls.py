...
urlpatterns = patterns('',
    ...
    (r'^idc/idc_edit/$',idc_edit),
    (r'^idcresult/$',idcresult),
    (r'^domain/$',domain_name),
    (r'^adddomain/$',adddomain),
    (r'^domain/deldomain/$',deldomain),
    (r'^domain/domain_edit/$',domain_edit),
    (r'^domain_result/$',domain_result),
    (r'^mac/$',mac),
    (r'^addmac/$',addmac),
    (r'^mac/check_host',check_host),
    (r'^mac/mac_delete/$',mac_delete),
    (r'^mac/mac_edit/$',mac_edit),
    (r'^mac/mac_search/$',mac_search),
    ...
    (r'^net_dev/net_search/$',net_search),
